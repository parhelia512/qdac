  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if StrCmpW(PQCharW(AChild.Name), 'img', True) = 0 then

          continue;

        if StrCmpW(PQCharW(AChild.Name), 'input', True) = 0 then
        ...
        if StrCmpW(PQCharW(AChild.Name), 'p', True) = 0 then
